...
def run():
    ...
    try:
        ...
        print("❌ 初始结构校正失败：", e)
        print("⚠️ 启用 fallback：直接使用原始节点继续运行（可能精度不高）")
    # 继续使用原始 env_nodes，略过校正
    ...
    for step in range(100):
        ...
        x0, y0 = com[0], com[1]
        print("node_positions shape:", structure.node_positions.shape)
        print("node_positions content:", structure.node_positions)
